...
describe("resolveModelWithTier", () => {
  ...
  describe("Gemini 3 preview models (Issue #115)", () => {
    ...
    it("gemini-flash-latest aliases to Gemini 3.8 Flash with default low thinking", () => {
    ...
    it("gemini-3.8-flash defaults to low thinking", () => {
    ...
    it("antigravity-gemini-3.8-flash defaults to low thinking with explicit quota", () => {
  ...
  describe("Antigravity Gemini 3 with tier suffix", () => {
    ...
    it.each([
      ["antigravity-gemini-3.8-flash", "gemini-3.8-flash-low", "low"],
      ["antigravity-gemini-3.8-flash-minimal", "gemini-3.8-flash-low", "low"],
