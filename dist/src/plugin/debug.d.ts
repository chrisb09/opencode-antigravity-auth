 ...
 */
export declare function maskHeadersForLog(headers?: HeadersInit | Headers): Record<string, string>;
export declare function sanitizeUrlForLog(urlString: string): string;
