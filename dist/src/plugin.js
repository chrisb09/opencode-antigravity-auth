...
import { ANTIGRAVITY_DEFAULT_PROJECT_ID, ANTIGRAVITY_ENDPOINT, ANTIGRAVITY_ENDPOINT_FALLBACKS, ANTIGRAVITY_ENDPOINT_PROD, ANTIGRAVITY_PROVIDER_ID, getAntigravityHeaders, } from "./constants";
import { authorizeAntigravity, exchangeAntigravity } from "./antigravity/oauth";
import { accessTokenExpired, isOAuthAuth, parseRefreshParts, formatRefreshParts } from "./plugin/auth";
import { pressEnterToContinue, promptAddAnotherAccount, promptLoginMode, promptProjectId } from "./plugin/cli";
import { ensureProjectContext } from "./plugin/project";
import { startAntigravityDebugRequest, logAntigravityDebugResponse, logAccountContext, logRateLimitEvent, logRateLimitSnapshot, logResponseBody, logModelFamily, isDebugEnabled, getLogFilePath, initializeDebug, sanitizeUrlForLog, } from "./plugin/debug";
...
import { isGeminiPublicOnlyModel, resolveModelWithTier, } from "./plugin/transform/model-resolver";
...
import { createAntigravityOnlyModelErrorResponse, extractRequestedGeminiModel, fetchWithAgySdkCredential, fetchGeminiApiModels, getAgySdkCredentials, isAgySdkSupportedRequest, isAntigravityOnlyGenerativeLanguageRequest, isApiKeyAuth, isRetryableAgySdkCredentialStatus, selectAgySdkCredential, } from "./plugin/api-key";
import { OPENCODE_MODEL_DEFINITIONS, mergeModelDefinitions, modelsFromAntigravityAvailableModels, modelsFromGeminiApi, } from "./plugin/config/models";
import { getCachedAntigravityAvailableModels, recordAntigravityAvailableModels, recordPublicGeminiApiModels, } from "./plugin/model-catalog";
...
async function modelsFromOAuthAuth(config, auth, client, providerId) {
    if (!config.model_discovery.enabled || !config.model_discovery.antigravity)
        return {};
